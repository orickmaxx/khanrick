...
function setupMenu() {
    ...
    function setupDropdown() {
        ...
        let featuresList = [
            ...
            { name: 'autoAnswerDelay', className: 'autoAnswerDelay', type: 'range', variable: 'features.autoAnswerDelay', attributes: 'style="display:none;" min="1" max="3" value="1"', labeled: true }],
