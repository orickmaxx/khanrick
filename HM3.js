...
script.src = './oneko.js'; // Caminho para o arquivo oneko.js na mesma pasta
script.onload = () => {
    console.log('Oneko.js foi carregado com sucesso!');
    // Aqui você pode executar funcionalidades que dependem do oneko.js
};
