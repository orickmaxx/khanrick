...
// Primeiro, carregue o oneko.js
const script = document.createElement('script');
script.src = './oneko.js'; // Caminho para o arquivo na mesma pasta
script.onload = () => {
    console.log('Oneko.js carregado com sucesso!');
    // Agora você pode usar as funções do Oneko.js
};
document.head.appendChild(script);

// Seu código para o Khan Academy vem depois
console.log("Script do Khan Academy carregado!");
...
function setupMenu() {
    ...
    function setupWatermark() {
        ...
        watermark.innerHTML = `<span style="text-shadow: -1px 0.5px 0 #fa4437, -2px 0px 0 #fa4437;">H&M</span> <span style="color:gray; padding-left:2px; font-family: Arial, sans-serif; font-size:10px">${ver}</span>`;
    ...
    function setupDropdown() {
        ...
        let featuresList = [
            ...
            [{ name: 'minuteFarm', type: 'checkbox', variable: 'features.minuteFarmer', labeled: true, label: 'Farmar Minutos' },
            { name: 'customBanner', type: 'checkbox', variable: 'features.customBanner', labeled: true, label: 'Banner Customizado' },
    ...
    function setupStatusPanel() {
        ...
        const update = async () => statsPanel.innerHTML = `
            <span style="text-shadow: -1px 0.5px 0 #p, -2px 0px 0 #fa4437;">H&M</span>
    ...
    setupWatermark(); setupDropdown(); setupStatusPanel();
}
...
/* Inject */
if (!/^https?:\/\/pt\.khanacademy\.org/.test(window.location.href)) { alert("❌ Khanrick Failed to Injected!\n\nVocê precisa executar o Khanrick no site do Khan Academy! (https://pt.khanacademy.org/"); window.location.href = "https://pt.khanacademy.org/";};
